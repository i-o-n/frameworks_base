...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_PARTIAL_SCREENSHOT_ACTIVE     = 55 << MSG_SHIFT;
    private static final int MSG_TOGGLE_SETTINGS_PANEL         = 56 << MSG_SHIFT;
    private static final int MSG_KILL_FOREGROUND_APP           = 57 << MSG_SHIFT;
