...
import com.android.internal.util.ion.ImageHelper;
...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView() {
        ...
        boolean showNav = Settings.Secure.getInt(mContext.getContentResolver(),
                ...
                NavbarUtils.hasNavbarByDefault(mContext) ? 1 : 0) != 0;
        if (DEBUG)
...
private void swapWhiteBlackAccent() {
    ...
    protected void updateTheme(boolean themeNeedsRefresh) {
        ...
        if (themeNeedsRefresh || isUsingDarkTheme() != useDarkTheme) {
            ...
            mUiOffloadThread.submit(() -> {
                ...
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.light",
    ...
    protected final ContentObserver mNavbarObserver = new ContentObserver(mHandler) {
        ...
        public void onChange(boolean selfChange) {
            ...
            if (!NavbarUtils.hasNavbarByDefault(mContext)) {
