...
public class QSFooterImpl extends FrameLayout implements Tunable, QSFooter,
    ...
    private void updateVisibilities() {
        ...
        mMultiUserSwitch.setVisibility(showUserSwitcher() ? (isUserEnabled() ? View.VISIBLE : View.INVISIBLE) : View.INVISIBLE);
    ...
    public boolean isUserEnabled() {
        return Settings.System.getInt(mContext.getContentResolver(),
            Settings.System.QS_USER_TOGGLE, 1) == 1;
    }
    ...
    private void startIonIonizerActivity() {
        Intent nIntent = new Intent(Intent.ACTION_MAIN);
        nIntent.setClassName("com.android.settings",
            "com.android.settings.Settings$IonIonizerActivity");
