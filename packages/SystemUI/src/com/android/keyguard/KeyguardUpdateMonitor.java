...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener,
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
                ...
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                maxChargingMicroAmp, maxChargingMicroVolt, maxChargingMicroWatt, temperature, dashChargeStatus, turboPowerStatus, superChargeStatus));
    ...
    public static class BatteryStatus {
        ...
        public BatteryStatus(int status, int level, int plugged, int health,
                int maxChargingCurrent, int maxChargingVoltage, int maxChargingWattage, int temperature, boolean dashChargeStatus, boolean turboPowerStatus, boolean superChargeStatus) {
            this.status = status;
            this.level = level;
