...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            boolean doShowNavbar = Settings.Secure.getIntForUser(resolver,
                    ...
                    NavbarUtils.isEnabled(mContext) ? 1 : 0,
                    UserHandle.USER_CURRENT) == 1;
    ...
    private boolean shouldDisableKey(int keyCode) {
        return mNavbarVisible && (keyCode == KeyEvent.KEYCODE_HOME
    ...
    public void layoutWindowLw(WindowState win, WindowState attached, DisplayFrames displayFrames) {
        ...
        final boolean hasNavBar = (isDefaultDisplay && mNavbarVisible
    ...
    private void takeScreenrecord(final int mode) {
        synchronized (mScreenrecordLock) {
            ...
            ComponentName cn = new ComponentName("com.android.systemui",
                    "com.android.systemui.ion.screenrecord.TakeScreenrecordService");
