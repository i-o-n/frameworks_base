...
public class DisplayPolicy {
    ...
    public void onConfigurationChanged() {
        ...
        final int uiMode = mService.mPolicy.getUiMode();
        final boolean showNavbar = IonUtils.shouldShowGestureNav(mContext);
        final boolean isButtonMode = IonUtils.isThemeEnabled("com.android.internal.systemui.navbar.twobutton")
